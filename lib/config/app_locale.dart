...
class AppLocale extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'es': {
      // Login
      'welcome': '¡Bienvenido!',
      'rnc_label': 'RNC o Cédula',
      'rnc_hint': 'Ej: 101234567',
      ...
      'rnc_required': 'Ingresa tu RNC o cédula',
    ...
    'en': {
      ...
      'rnc_required': 'Enter your RNC or ID',
    ...
    'fr': {
      'welcome': 'Bienvenue !',
      'rnc_label': 'RNC ou ID fiscal',
      'rnc_hint': 'Ex: 101234567',
      ...
      'rnc_required': 'Entrez votre RNC ou ID',
